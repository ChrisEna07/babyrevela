    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-md">
        <motion.div
          ...
          className="relative flex w-full max-w-lg flex-col items-center gap-6 rounded-[2.5rem] border-4 border-white bg-white p-6 shadow-2xl text-center sm:p-8"
        >
          {/* Close Button */}
          <button
            onClick={onClose}
          ...
          <span className="rounded-full bg-purple-100 px-4 py-1 text-xs font-black uppercase text-purple-900">
            🧪 Simulador de Prueba de Revelación
          </span>

          {testPhase === "idle" && (
            <div className="flex flex-col items-center gap-4 w-full">
              <h2 className="font-display text-2xl text-slate-800">
                Prueba de Animaciones y Conteo
              </h2>
              <p className="text-xs font-medium text-slate-600 leading-relaxed">
                Prueba la experiencia exacta que verán los invitados durante la cuenta regresiva y la explosión de revelación sin modificar el estado real del evento.
              </p>
              ...
              <div className="grid grid-cols-2 gap-3 w-full pt-2">
                ...
                >
                  ...
                  <span>Probar Revelación de NIÑO</span>
                </button>
                ...
                >
                  <span className="text-4xl">👧</span>
                  <span>Probar Revelación de NIÑA</span>
                </button>
              </div>
            </div>
          )}
          ...
          {testPhase === "countdown" && (
            <div className="flex flex-col items-center gap-4 my-6">
              ...
              <p className="text-xs font-bold text-slate-500">
                Preparando explosión de color para Team {testTeam === "boy" ? "Niño 👦" : "Niña 👧"}...
              </p>
            </div>
          )}
          ...
          {testPhase === "revealed" && (
            <div className="flex flex-col items-center gap-4 my-2 w-full">
              ...
              <p className="text-xs font-semibold text-slate-600">
                ¡Animación y confetti probados exitosamente!
              </p>
